...
export default function CreateNewGroup() {
  ...
  return (
    <Button
      ...
      variant={"ghost"}
      className='w-[95%] self-center flex justify-between rounded-3xl space-x-4 bg-foreground/10 hover:bg-foreground/15 active:bg-foreground/20 transition-all duration-300'>
