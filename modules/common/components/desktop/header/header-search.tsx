...
export default function HeaderSearch() {
  ...
  return (
    <div
      ...
      role='button'
      className='relative w-[40%] h-8 flex justify-start items-center pl-8 border border-foreground rounded-lg bg-foreground/5 active:scale-95 hover:bg-foreground/10 transition cursor-pointer focus:ring-2 focus:ring-foreground/50'>
