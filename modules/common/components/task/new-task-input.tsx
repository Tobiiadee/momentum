...
export default function NewTaskInput() {
  ...
  return (
    <div className="flex flex-col space-y-3">
      ...
      <Textarea placeholder="Describe your task" className='placeholder:text-sm text-sm placeholder:text-foreground/60 w-full bg-foreground/5 focus-visible:ring-0 active:border-none active:outline-none border-none outline-none'/>
    </div>
  );
}
